...
- pre-game leader thumbnails use the shared small dimensions from `dimensionsForSize("sm")`, while match score-card leaders now use the shared foundation large dimensions from `dimensionsForSize("lg")` on desktop;
