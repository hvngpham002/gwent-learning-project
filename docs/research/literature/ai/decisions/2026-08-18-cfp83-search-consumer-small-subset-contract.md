...
Current is `subset_ready` with 663 roots, 1,488 actions, and 63 inherited skipped roots. Robust is `subset_ready` with 5,314 roots, 12,109 actions, and 340 inherited skipped roots. Both have zero selected-root closure mismatches. The repair remaps every compact dictionary id against a selected-only projection and proves all emitted IDs are in range and decode to the original selected cFp80 values; robust repeated deterministically.
