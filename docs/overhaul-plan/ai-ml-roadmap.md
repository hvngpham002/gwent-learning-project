...
cFp82 is a docs/metadata-only decision over the committed cFp81 casebook. It
recommends cFp83 `search-consumer-small-subset-contract-v0` because robust
cFp81 evidence has a usable ordinary ready slice (24,405 actions / 9,580 roots)
but broader high-branching (85,651 actions / 19,094 roots) and high-collision
(43,629 actions / 23,338 roots) pressure blocks direct search/value/ranking
claims. cFp82 creates no runner and no new artifact family.
