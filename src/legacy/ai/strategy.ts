// src/ai/strategy.ts
import { Card, CardType, CardAbility, GameState, UnitCard, RowPosition, LeaderAbility, LeaderCard } from '@/legacy/types/card';
import { calculateRowStrength, calculateTotalScore, calculateWeatherImpact, findCloseScorchTargets, findScorchTargets } from '@/legacy/utils/gameHelpers';
