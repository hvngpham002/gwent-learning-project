...
import { Card, PlayerState, GameState, BoardState, RowPosition, CardType, UnitCard, CardAbility, SpecialCard, Faction, LeaderAbility } from '@/legacy/types/card';
import GameBoard from './GameBoard';
import { canPlayWeatherInRow, canTriggerMedic, shuffle } from '@/legacy/utils/gameHelpers';
import { createInitialDeck } from '@/legacy/utils/deckBuilder';
import useAI from '@/legacy/hooks/useAI';
import { calculateTotalScore } from '@/legacy/utils/gameHelpers';
import { handleDecoyAction, playCard as playCardHelper } from '@/legacy/hooks/useGameLogic';
