...
import { AIStrategyCoordinator, PlayDecision } from '@/legacy/ai/strategy';
import { 
...
import { playCardAction } from '@/legacy/store/thunks/gameThunks';
import { calculateTotalScore, shuffle } from '@/legacy/utils/gameHelpers';
