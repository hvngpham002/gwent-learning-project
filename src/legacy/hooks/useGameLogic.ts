import { PlayDecision } from "@/legacy/ai/strategy";
import { Card, CardAbility, CardType, GameState, LeaderAbility, LeaderCard, RowPosition, SpecialCard, UnitCard } from "@/legacy/types/card";
import { drawCards, findCloseScorchTargets, findScorchTargets } from "@/legacy/utils/gameHelpers";
